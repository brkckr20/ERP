                            ...
                            <div className='shrink-0'>
                                <table className=''>
                                    <thead className='bg-blue-800'>
                                        <tr className='text-white text-center overflow-x-scroll w-full'>
                                            <td className='bg-red-600'>Sil</td>
                                            <td className='w-[200px] shrink-0'>İşlem Kodu</td>
                                            <td className='w-[200px] shrink-0'>Aks. Kodu</td>
                                            <td className='w-[200px] shrink-0'>Aks. Cinsi</td>
                                            <td className='w-[200px] shrink-0'>Aks. Ebat</td>
                                            <td className='w-[200px] shrink-0'>Aks. Grup</td>
                                            <td className='w-[200px] shrink-0'>Aks. Renk</td>
                                            <td className='w-[200px] shrink-0'>Ebat/Beden</td>
                                            <td className='w-[200px] shrink-0'>Özellik 1</td>
                                            <td className='w-[200px] shrink-0'>Özellik 2</td>
                                            <td className='w-[200px] shrink-0'>Özellik 3</td>
                                            <td className='w-[200px] shrink-0'>Özellik 3</td>
                                            <td className='w-[200px] shrink-0'>Sip.No</td>
                                            <td className='w-[200px] shrink-0'>G.Miktar</td>
                                            <td className='w-[200px] shrink-0'>G.Fiyat</td>
                                            <td className='w-[200px] shrink-0'>G.Döviz</td>
                                            <td className='w-[200px] shrink-0'>Kalem Açıklama</td>
                                            <td className='w-[200px] shrink-0'>Kalem Kayıt.No</td>
                                        </tr>
                                    </thead>
